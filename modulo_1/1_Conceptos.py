...
disciplina esencial en numerosos compos como negocios, ciencia, ingeniería y más.

Principales etapas Del Análisis de Datos:
1. Recolección de datos: Obtención de datos de diversas fuentes.
2. Limpieza de datos: Corrección o eliminación de datos incorrectos o irrelevantes.
3. Exploración de datos: Análisis inicial para descubrir patrones, detectar anomalías y verificar supuestos.
4. Modelado de Datos: Aplicación de modelos estadísticos o de aprendizaje automático.
5. Interpretación y Comunicación: Presentación de los resultados de manera clara y concisa.

Tipos de Datos:
1. Estructurados: Datos organizados en un formato definido como tablas (por ejemplo, bases de datos relacionales).
2. No estructurados: Datos sin una estructura predefinida (por ejemplo, texto libre, imágenes, videos).
3. Semiestructurados: Datos que no están en tablas pero tienen etiquetas o marcadores que los separan(por ejemplo,XML,JSON).

Herramientas Comunes:
1. Lenguajes de programación: Python, R.
2. Bibliotecas para Python: Pandas, Numpy, Matplotib, Seaborn.
3. Software de Visualización: Tableau, Power BI.
Bases de Datos: SQL
"""
...
más impulsado por datos: empresas, gobiernos, y organizaciones los recopilan constantemente para optimizar procesos, mejorar
productos o servicios y tomar decisiones estratégicas.

Por ejemplo, en el comercio eléctronico, los datos permiten entender los hábitos de compra de los clientes, lo que ayuda a
